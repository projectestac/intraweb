...
class CategoryUtil
{
     ...
     * @return The resulting folder object array
     */
    function getSubCategories($cid, $recurse = true, $relative = true, $includeRoot = false, $includeLeaf = true, $all = false, $excludeCid = '', $assocKey = '', $attributes = null)
    {
        if (!$cid) {
            return false;
        }
        ...
        $cats = CategoryUtil::getSubCategoriesForCategory($rootCat, $recurse, $relative, $includeRoot, $includeLeaf, $all, $exclCat, $assocKey, $attributes);
     ...
     * @return The resulting folder object array
     */
    function getSubCategoriesByPath($apath, $field = 'ipath', $recurse = true, $relative = true, $includeRoot = false, $includeLeaf = true, $all = false, $excludeCid = '', $assocKey = '', $attributes = null)
    {
        if (!$apath) {
            return false;
        }
