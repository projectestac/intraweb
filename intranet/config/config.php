...
/*
$PNConfig['DBInfo']['moodle']['dbtype'] = 'mysql';
$PNConfig['DBInfo']['moodle']['dbhost'] = '';
$PNConfig['DBInfo']['moodle']['dbuname'] = '';
$PNConfig['DBInfo']['moodle']['dbpass'] = '';
$PNConfig['DBInfo']['moodle']['dbname'] = '';
$PNConfig['DBInfo']['moodle']['encoded'] = 0;
$PNConfig['DBInfo']['moodle']['pconnect']  = 0;
$PNConfig['DBInfo']['moodle']['dbtabletype'] = 'myisam';
